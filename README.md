...
Commits 
           ...
           This are like snapshots of your project. Each commit saves the state of your files and includes a unique ID and a message that describes the changes made.
...
Scenario: 
    ...
    You want to add a feature or fix a bug in an open-source project. Forking the repository lets you make changes without affecting the original project.
...
Importance Project Boards on GitHub and how they be used to track bugs, manage tasks, and improve project organization with examples
